...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Senator Quits Montana Race After Charge Of Plagiarism 8/7/2014";
        CTransaction txNew;
        txNew.nTime = 1407472659;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb09dada1c723d4103886aac64e0e874261a8ab01a47b1f87460af22a7ad106c4"));
        block.print();
